...
- `OpenAIChatGenerator` is recommended to use the `DeepSeek-V4-Pro` model.  
...
- `OpenAIChatGenerator` [connects using the OpenAI SDK method](https://console.cloud.tencent.com/lkeap). The component parameter configuration is `{"base_url":"https://api.lkeap.cloud.tencent.com/v1","api_key":"xxx","model":"DeepSeek-V4-Pro"}`.  
