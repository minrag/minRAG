...
INSERT INTO component (status,sortNo,createUser,updateTime,createTime,parameter,componentType,id) VALUES (1,5,'','2025-02-02 19:45:25','2025-02-02 19:45:25','{"apikey":"A4FTACZVPGAIV8PZCKIBEUGV7ZBMXTIBEGUGNC11","model":"bge-reranker-v2-m3","apiBaseURL":"https://ai.gitee.com/api/serverless/rerank","topK":5,"score":0.1}','DocumentChunksRanker','DocumentChunksRanker');
...
INSERT INTO component (status,sortNo,createUser,updateTime,createTime,parameter,componentType,id) VALUES (1,7,'','2025-02-02 19:45:25','2025-02-02 19:45:25','{"memoryLength":20}','OpenAIChatMessage','OpenAIChatMessage');
INSERT INTO component (status,sortNo,createUser,updateTime,createTime,parameter,componentType,id) VALUES (1,8,'','2025-02-02 19:45:25','2025-02-02 19:45:25','{"apikey":"A4FTACZVPGAIV8PZCKIBEUGV7ZBMXTIBEGUGNC11","model":"DeepSeek-R1-Distill-Qwen-32B","apiBaseURL":"https://ai.gitee.com/v1","defaultHeaders":{"X-Failover-Enabled": "true", "X-Package": "1910"}}','OpenAIChatCompletion','OpenAIChatCompletion');
