...
INSERT INTO component (status,sortNo,createUser,updateTime,createTime,parameter,componentType,id) VALUES (1,6,'','2025-02-02 19:45:25','2025-02-02 19:45:25','{"promptTemplate":"根据文档,请回答问题,回复中不要说提供了文档.\n 文档: \n {{ range $i,$v := .documentChunks }} {{ $v.Markdown }} \n {{end }} \n问题: {{ .query }} \n回答:"}','PromptBuilder','PromptBuilder');
