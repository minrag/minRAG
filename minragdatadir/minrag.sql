...
INSERT INTO component (status,sortNo,createUser,updateTime,createTime,parameter,componentType,id) VALUES (1,12,'','2025-02-02 19:45:25','2025-02-02 19:45:25','{"model":"Qwen2.5-72B-Instruct","stream":true,"defaultHeaders":{"X-Failover-Enabled": "true", "X-Package": "1910"}}','OpenAIChatGenerator','OpenAIChatGenerator');
INSERT INTO component (status,sortNo,createUser,updateTime,createTime,parameter,componentType,id) VALUES (1,13,'','2025-02-02 19:45:25','2025-02-02 19:45:25','{"start":"OpenAITextEmbedder","process":{"OpenAITextEmbedder":"VecEmbeddingRetriever","VecEmbeddingRetriever":"FtsKeywordRetriever","FtsKeywordRetriever":"DocumentChunksReranker","DocumentChunksReranker":"PromptBuilder","PromptBuilder":"OpenAIChatMemory","OpenAIChatMemory":"OpenAIChatGenerator"}}','Pipeline','default');
