...
INSERT INTO component (status,sortNo,createUser,updateTime,createTime,parameter,componentType,id) VALUES (1,15,'','2025-10-24 10:24:00','2025-10-24 10:24:00','{"promptTemplate":"已知问题和多个文档树状结构,需要找出所有可能包含答案的文档节点ID.\n 问题: {{ .query }} \n   文档树状结构:\n {{if .documents}} {{ range $i,$v := .documents }} 文档名称:{{ $v.Name }} \n 树状结构:{{ $v.Toc }} \n\n {{end }}{{end}} \n\n 请直接回复 JSON 格式:{\"result\":[node_id1, node_id2, ...]"}','MarkdownTOCRetriever','MarkdownTOCRetriever');
