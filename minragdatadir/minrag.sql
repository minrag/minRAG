...
INSERT INTO component (status,sortNo,createUser,updateTime,createTime,parameter,componentType,id) VALUES (1,6,'','2025-10-24 10:24:00','2025-10-24 10:24:00','','MarkdownIndex','MarkdownIndex');
...
INSERT INTO component (status,sortNo,createUser,updateTime,createTime,parameter,componentType,id) VALUES (1,9,'','2025-10-24 10:24:00','2025-10-24 10:24:00','{"model":"Qwen3-Embedding-8B"}','OpenAIDocumentEmbedder','OpenAIDocumentEmbedder');
...
INSERT INTO component (status,sortNo,createUser,updateTime,createTime,parameter,componentType,id) VALUES (1,12,'','2025-10-24 10:24:00','2025-10-24 10:24:00','{"model":"Qwen3-Embedding-8B"}','OpenAITextEmbedder','OpenAITextEmbedder');
...
INSERT INTO component (status,sortNo,createUser,updateTime,createTime,parameter,componentType,id) VALUES (1,15,'','2025-10-24 10:24:00','2025-10-24 10:24:00','{"promptTemplate":"配合search_document_toc_by_id工具函数进行调用,文档列表:\n {{if .documents}} {{ range $i,$v := .documents }} 文档ID:{{ $v.Id }} \n 文档名称:{{ $v.Name }} \n 文档摘要:{{ $v.Summary }}  \n\n {{end }}{{end}}"}','MarkdownRetriever','MarkdownRetriever');
...
INSERT INTO component (status,sortNo,createUser,updateTime,createTime,parameter,componentType,id) VALUES (1,24,'','2025-10-24 10:24:00','2025-10-24 10:24:00','{"id":"indexPipeline","downStream":[{"id":"MarkdownConverter","downStream":[{"id":"DocumentSplitter"}]},{"id":"DocumentSplitter","downStream":[{"id":"OpenAIDocumentEmbedder"}]},{"id":"OpenAIDocumentEmbedder","downStream":[{"id":"SQLiteVecDocumentStore"}]},{"id":"SQLiteVecDocumentStore"}]}','Pipeline','indexPipeline');
INSERT INTO component (status,sortNo,createUser,updateTime,createTime,parameter,componentType,id) VALUES (1,25,'','2025-10-24 10:24:00','2025-10-24 10:24:00','{"id":"default","downStream":[{"id":"OpenAITextEmbedder","downStream":[{"id":"VecEmbeddingRetriever"}]},{"id":"VecEmbeddingRetriever","downStream":[{"id":"FtsKeywordRetriever"}]},{"id":"FtsKeywordRetriever","downStream":[{"id":"DocumentChunkReranker"}]},{"id":"DocumentChunkReranker","downStream":[{"id":"PromptBuilder"}]},{"id":"PromptBuilder","downStream":[{"id":"OpenAIChatMemory"}]},{"id":"OpenAIChatMemory","downStream":[{"id":"OpenAIChatGenerator"}]},{"id":"OpenAIChatGenerator","downStream":[{"id":"ChatMessageLogStore"}]},{"id":"ChatMessageLogStore"}]}','Pipeline','default');
