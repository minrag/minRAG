...
INSERT INTO component (status,sortNo,createUser,updateTime,createTime,parameter,componentType,id) VALUES (1,7,'','2025-02-02 19:45:25','2025-02-02 19:45:25','{"topK":5,"score":0.0}','VecEmbeddingRetriever','VecEmbeddingRetriever');
INSERT INTO component (status,sortNo,createUser,updateTime,createTime,parameter,componentType,id) VALUES (1,8,'','2025-02-02 19:45:25','2025-02-02 19:45:25','{"topK":5,"score":0.0}','FtsKeywordRetriever','FtsKeywordRetriever');
...
INSERT INTO component (status,sortNo,createUser,updateTime,createTime,parameter,componentType,id) VALUES (1,11,'','2025-02-02 19:45:25','2025-02-02 19:45:25','{"memoryLength":10}','OpenAIChatMemory','OpenAIChatMemory');
INSERT INTO component (status,sortNo,createUser,updateTime,createTime,parameter,componentType,id) VALUES (1,12,'','2025-02-02 19:45:25','2025-02-02 19:45:25','{"model":"Qwen2.5-72B-Instruct","defaultHeaders":{"X-Failover-Enabled": "true", "X-Package": "1910"}}','OpenAIChatGenerator','OpenAIChatGenerator');
INSERT INTO component (status,sortNo,createUser,updateTime,createTime,parameter,componentType,id) VALUES (1,13,'','2025-02-02 19:45:25','2025-02-02 19:45:25','','ChatMessageLogStore','ChatMessageLogStore');
INSERT INTO component (status,sortNo,createUser,updateTime,createTime,parameter,componentType,id) VALUES (1,14,'','2025-02-02 19:45:25','2025-02-02 19:45:25','{"start":"OpenAITextEmbedder","process":{"OpenAITextEmbedder":"VecEmbeddingRetriever","VecEmbeddingRetriever":"FtsKeywordRetriever","FtsKeywordRetriever":"DocumentChunksReranker","DocumentChunksReranker":"PromptBuilder","PromptBuilder":"OpenAIChatMemory","OpenAIChatMemory":"OpenAIChatGenerator","OpenAIChatGenerator":"ChatMessageLogStore"}}','Pipeline','default');
