...
INSERT INTO component (status,sortNo,createUser,updateTime,createTime,parameter,componentType,id) VALUES (1,15,'','2025-10-24 10:24:00','2025-10-24 10:24:00','{"base_url":"https://ai.gitee.com/api/serverless/bge-reranker-v2-m3/rerank","model":"bge-reranker-v2-m3","top_n":5,"score":0.1}','GiteeDocumentChunkReranker','GiteeDocumentChunkReranker');
INSERT INTO component (status,sortNo,createUser,updateTime,createTime,parameter,componentType,id) VALUES (1,16,'','2025-10-24 10:24:00','2025-10-24 10:24:00','{"base_url":"https://dashscope.aliyuncs.com/api/v1/services/rerank/text-rerank/text-rerank","model":"gte-rerank","return_documents":true,"top_n":5,"score":0.1}','BaiLianDocumentChunkReranker','BaiLianDocumentChunkReranker');
INSERT INTO component (status,sortNo,createUser,updateTime,createTime,parameter,componentType,id) VALUES (1,17,'','2025-10-24 10:24:00','2025-10-24 10:24:00','{"model":"bge-reranker-v2-m3","top_n":5,"score":0.1}','DocumentChunkReranker','DocumentChunkReranker');
INSERT INTO component (status,sortNo,createUser,updateTime,createTime,parameter,componentType,id) VALUES (1,18,'','2025-10-24 10:24:00','2025-10-24 10:24:00','{"promptTemplate":"{{if .documentChunks}}根据文档,请回答问题,回复中不要说提供了文档.\n 文档: \n {{ range $i,$v := .documentChunks }} {{ $v.Markdown }} \n {{end }} \n{{end}}问题: {{ .query }} \n回答:"}','PromptBuilder','PromptBuilder');
...
INSERT INTO component (status,sortNo,createUser,updateTime,createTime,parameter,componentType,id) VALUES (1,20,'','2025-10-24 10:24:00','2025-10-24 10:24:00','{"model":"DeepSeek-V3_1","defaultHeaders":{"X-Failover-Enabled": "true", "X-Package": "1910"}}','OpenAIChatGenerator','OpenAIChatGenerator');
