...
INSERT INTO component (status,sortNo,createUser,updateTime,createTime,parameter,componentType,id) VALUES (1,7,'','2025-10-24 10:24:00','2025-10-24 10:24:00','{"model":"lke-text-embedding-v1"}','LKEDocumentEmbedder','LKEDocumentEmbedder');
INSERT INTO component (status,sortNo,createUser,updateTime,createTime,parameter,componentType,id) VALUES (1,8,'','2025-10-24 10:24:00','2025-10-24 10:24:00','{"model":"bge-m3","defaultHeaders":{"X-Failover-Enabled": "true", "X-Package": "1910"}}','OpenAIDocumentEmbedder','OpenAIDocumentEmbedder');
...
INSERT INTO component (status,sortNo,createUser,updateTime,createTime,parameter,componentType,id) VALUES (1,10,'','2025-10-24 10:24:00','2025-10-24 10:24:00','{"model":"lke-text-embedding-v1"}','LKETextEmbedder','LKETextEmbedder');
INSERT INTO component (status,sortNo,createUser,updateTime,createTime,parameter,componentType,id) VALUES (1,11,'','2025-10-24 10:24:00','2025-10-24 10:24:00','{"model":"bge-m3","defaultHeaders":{"X-Failover-Enabled": "true", "X-Package": "1910"}}','OpenAITextEmbedder','OpenAITextEmbedder');
...
INSERT INTO component (status,sortNo,createUser,updateTime,createTime,parameter,componentType,id) VALUES (1,15,'','2025-10-24 10:24:00','2025-10-24 10:24:00','{"base_url":"https://dashscope.aliyuncs.com/api/v1/services/rerank/text-rerank/text-rerank","model":"gte-rerank-v2","return_documents":true,"top_n":5,"score":0.1}','BaiLianDocumentChunkReranker','BaiLianDocumentChunkReranker');
INSERT INTO component (status,sortNo,createUser,updateTime,createTime,parameter,componentType,id) VALUES (1,16,'','2025-10-24 10:24:00','2025-10-24 10:24:00','{"model":"bge-reranker-v2-m3","top_n":5,"score":0.1}','DocumentChunkReranker','DocumentChunkReranker');
INSERT INTO component (status,sortNo,createUser,updateTime,createTime,parameter,componentType,id) VALUES (1,17,'','2025-10-24 10:24:00','2025-10-24 10:24:00','{"promptTemplate":"{{if .webSerachDocuments}} 联网搜索的相关网页内容,忽略内容中无关广告信息.{{ range $i,$v := .webSerachDocuments }} {{ $v.Name }} \n {{ $v.Id }} \n {{ $v.Markdown }} \n\n {{end }}{{end}} {{if .documentChunks}}根据文档,请回答问题,回复中不要说提供了文档.\n 文档: \n {{ range $i,$v := .documentChunks }} {{ $v.Markdown }} \n {{end }} \n{{end}}问题: {{ .query }} \n回答:"}','PromptBuilder','PromptBuilder');
INSERT INTO component (status,sortNo,createUser,updateTime,createTime,parameter,componentType,id) VALUES (1,18,'','2025-10-24 10:24:00','2025-10-24 10:24:00','{"memoryLength":3}','OpenAIChatMemory','OpenAIChatMemory');
INSERT INTO component (status,sortNo,createUser,updateTime,createTime,parameter,componentType,id) VALUES (1,19,'','2025-10-24 10:24:00','2025-10-24 10:24:00','{"model":"DeepSeek-V3.2-Exp","defaultHeaders":{"X-Failover-Enabled": "true", "X-Package": "1910"}}','OpenAIChatGenerator','OpenAIChatGenerator');
INSERT INTO component (status,sortNo,createUser,updateTime,createTime,parameter,componentType,id) VALUES (1,20,'','2025-10-24 10:24:00','2025-10-24 10:24:00','','ChatMessageLogStore','ChatMessageLogStore');
INSERT INTO component (status,sortNo,createUser,updateTime,createTime,parameter,componentType,id) VALUES (0,21,'','2025-10-24 10:24:00','2025-10-24 10:24:00','{"start":"MarkdownConverter","process":{"MarkdownConverter":"DocumentSplitter","DocumentSplitter":"OpenAIDocumentEmbedder","OpenAIDocumentEmbedder":"SQLiteVecDocumentStore"}}','Pipeline','indexPipeline');
INSERT INTO component (status,sortNo,createUser,updateTime,createTime,parameter,componentType,id) VALUES (1,22,'','2025-10-24 10:24:00','2025-10-24 10:24:00','{"start":"OpenAITextEmbedder","process":{"OpenAITextEmbedder":"VecEmbeddingRetriever","VecEmbeddingRetriever":"FtsKeywordRetriever","FtsKeywordRetriever":"DocumentChunkReranker","DocumentChunkReranker":"PromptBuilder","PromptBuilder":"OpenAIChatMemory","OpenAIChatMemory":"OpenAIChatGenerator","OpenAIChatGenerator":"ChatMessageLogStore"}}','Pipeline','default');
