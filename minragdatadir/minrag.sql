...
INSERT INTO component (status,sortNo,createUser,updateTime,createTime,parameter,componentType,id) VALUES (1,15,'','2025-10-24 10:24:00','2025-10-24 10:24:00','{"promptTemplate":"配合search_document_by_node工具函数进行调用,知识库文档树状结构:\n {{if .documents}} {{ range $i,$v := .documents }} 文档ID:{{ $v.Id }} \n 文档名称:{{ $v.Name }} \n 文档摘要:{{ $v.Summary }} \n 树状结构:{{ $v.Toc }} \n\n {{end }}{{end}}"}','MarkdownTOCRetriever','MarkdownTOCRetriever');
